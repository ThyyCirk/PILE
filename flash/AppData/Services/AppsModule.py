...
class Apps:
    def __init__(self, o=True):
        ...
        self.AppFile = '/flash/libs/AppOrder.json'
        
        self.Favourites = FileManager.search('favourites', self.AppFile) or []
        self.AllApps = FileManager.search('all', self.AppFile) or []
